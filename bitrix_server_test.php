<?php
#####################################
define('LAST_MODIFIED','18.01.2012');
#####################################
...
else
{
	...
	$M['TOP_LINKS']='
						...
						<a href="http://partners.1c-bitrix.ru/program/hosting.php#tab-requirements-link">Требования по настройкам хостинга</a><br>
						<a href="http://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=3">Учебный курс «Конфигурирование веб-систем для оптимальной работы»</a>';
